    ...
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-5xl mx-auto animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Проводите медицинские конференции и телемосты без технических сбоев — с гарантией качества и конфиденциальности
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-400">
              <div className="flex items-center">
                <Icon name="Shield" className="mr-1 text-emerald-400" size={16} />
                Конфиденциальность
              </div>
              <div className="flex items-center">
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Наши решения идеально подходят для</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="bg-gray-700 border-gray-600 hover:bg-gray-600 transition-all duration-300 hover:scale-105">
                ...
                <CardContent>
                  <CardDescription className="text-gray-300 text-center">{item.description}</CardDescription>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-red-400 mb-6">Проблемы обычных решений:</h3>
              {[
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-emerald-400 mb-6">Наше решение:</h3>
              {[
                ...
                <div key={index} className="flex items-start space-x-3">
                  <Icon name="Check" className="text-emerald-400 mt-1 flex-shrink-0" size={20} />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { step: "1", title: "Бриф", description: "Уточняем детали (15 минут)" },
                { step: "2", title: "Тест-день", description: "Проверяем оборудование и связь" },
                { step: "3", title: "Реализация", description: "Трансляция + интерактив (чат, голосования)" },
                { step: "4", title: "Отчет", description: "Статистика по участникам и активности" }
              ].map((item, index) => (
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            {["Bayer", "Eisai", "MicroPort®", "РЖД-Медицина", "Минздрав НСО"].map((client, index) => (
          ...
          <Card className="bg-gray-700 border-gray-600 max-w-2xl mx-auto">
            <CardHeader>
              <CardTitle className="text-center text-white">Кейс: Межрегиональная школа практикующих врачей</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-6">
          ...
          <Card className="bg-gray-700 border-gray-600 max-w-md mx-auto">
            <CardHeader className="text-center">
              <div className="text-4xl font-bold text-blue-400 mb-2">От 90 000 ₽</div>
              <CardTitle className="text-white">За мероприятие</CardTitle>
              <CardDescription className="text-gray-300">Точная стоимость зависит от сложности и длительности</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-emerald-600">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4">Хотите провести мероприятие без технических рисков?</h2>
          <p className="text-xl mb-8 opacity-90">Первая консультация — бесплатно</p>
